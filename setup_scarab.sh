...
# mkdir $WORKDIR/roi_trace
# cp $WORKDIR/scarab/src/deps/dynamorio/clients/drcachesim/tests/burst_static.cpp $WORKDIR/roi_trace/

# cd $WORKDIR/roi_trace && gdown 'https://drive.google.com/file/d/1izXMsz5DKzOTrH2Qejt_v0fzz43tE50z/view' -O CMakeLists.txt
# cd $WORKDIR/roi_trace && mkdir build && cd build
